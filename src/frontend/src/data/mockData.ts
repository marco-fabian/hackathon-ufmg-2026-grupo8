...
export const mockProcessos: Processo[] = [
  ...
  // ── Linha 11 ──────────────────────────────────────────────────────────────
  {
    ...
    statusDaIA: 'concluido',
    decisaoAdvogado: 'acordo',
    dataEntrada: '2025-01-19T11:30:00Z',
    advogadoResponsavel: advogados[4],
    tribunal: 'TJMG',
    prioridade: 'alta',
  ...
  // ── Linha 12 ──────────────────────────────────────────────────────────────
  {
    ...
    statusDaIA: 'em_analise',
    decisaoAdvogado: 'pendente',
    dataEntrada: '2025-01-20T14:00:00Z',
    advogadoResponsavel: advogados[5],
    tribunal: 'TJSP',
    prioridade: 'alta',
  ...
  // ── Linha 13 ──────────────────────────────────────────────────────────────
  {
    ...
    statusDaIA: 'concluido',
    decisaoAdvogado: 'defesa',
    dataEntrada: '2025-01-21T09:00:00Z',
    advogadoResponsavel: advogados[0],
    tribunal: 'TJRJ',
    prioridade: 'media',
  ...
  // ── Linha 14 ──────────────────────────────────────────────────────────────
  {
    ...
    statusDaIA: 'aguardando_subsidios',
    decisaoAdvogado: 'pendente',
    dataEntrada: '2025-01-22T15:30:00Z',
    advogadoResponsavel: advogados[1],
    tribunal: 'TJPR',
    prioridade: 'media',
  ...
  // ── Linha 15 ──────────────────────────────────────────────────────────────
  {
    ...
    statusDaIA: 'concluido',
    decisaoAdvogado: 'acordo',
    dataEntrada: '2025-01-23T12:00:00Z',
    advogadoResponsavel: advogados[2],
    tribunal: 'TJGO',
    prioridade: 'alta',
